 ...
 *
 * Disassembly of iASL2dElwY.aml, Mon Dec  3 10:35:23 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00011248 (70216)
 *     Revision         0x02
 *     Checksum         0x79
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x00000013)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xD688EE18, 0x01D1)
            ...
            Method (WMNB, 3, NotSerialized)
            {
                ...
                If (LEqual (Local0, 0x53545344))
                {
                    ...
                    If (LEqual (IIA0, 0x00120041))
                    {
                        ...
                        Else
                        {
                            Subtract (0x00010000, 0x21, Local2)
                            And (Local2, 0xFFFF, Local2)
                            Return (Add (0x00080000, Local2))
                        }
                    }
                    ...
                    If (LEqual (IIA0, 0x00120045))
                    {
                        If (And (^^PCI0.LPCB.EC0.EPWS, 0x02))
                        {
                            ...
                            {
                                Store (0x1E1C, Local2)
                                Add (Local2, 0x00010000, Local3)
                                Return (Add (0x00080000, Local3))
                            }
    ...
    Scope (\)
    {
        ...
        Name (VISB, Buffer (0x0E)
        {
            ...
            /* 0008 */  0x01, 0x00, 0x00, 0x00, 0x00, 0x00             
        })
